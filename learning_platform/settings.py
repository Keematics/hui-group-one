...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-#@bh!+1wa-r#e()1rt1##nk-s45u@rcd(2a2ktlz&gv0hf=wtw')
...
# For Render deployment, use DATABASE_URL from environment
# For local development, use individual DB settings
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'hui_learning_platform_db'),
...
# Custom User Model (we'll extend the default User)
...
# =====================================
# These settings are optimized for deploying on Render.com
